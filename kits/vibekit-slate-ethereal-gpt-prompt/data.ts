  ...
  projects: [
    {
      ...
      title: "ZenFocus AI",
      description:
        "An intelligent mindfulness companion that analyzes your calendar and pulse to suggest micro-meditation moments.",
      ...
      prompts: [
        {
          ...
          content:
            "You are a world-class mindfulness coach. Analyze the user's schedule (JSON below) and provide a 2-minute 'Zen Sprint' exercise based on their current stress level. Output must be structured JSON.",
        },
        {
          label: "Style System Prompt",
          content:
            "Generate a Tailwind color palette for a mindfulness app. Focus on sage greens and soft indigos. Avoid aggressive reds.",
        },
      ],
      lessons: [
    ...
    },
    {
      ...
      title: "VibeChart",
      description:
        "Visualize the sentiment of any codebase or document collection as a 3D topographic map.",
      ...
      prompts: [
        {
          label: "Code Analysis",
          content:
            "Analyze this file for emotional tone. Is the developer frustrated? Is the code written in a flow state? Return an array of scores (0-1).",
        },
      ],
      lessons: [
    ...
    },
    {
      ...
      description:
        "A collaborative sandbox for refining and testing complex LLM prompts with version control.",
      ...
      prompts: [
        {
          ...
          content:
            "Refactor the following prompt to be 30% more concise while retaining its specific instructions on tone and formatting.",
        },
      ],
      lessons: [
    ...
    },
    {
      ...
      title: "NeuralNews",
      description:
        "The first AI-generated daily newspaper, personalized to your hyper-specific technical interests.",
      ...
      prompts: [
        {
          ...
          content:
            "Rewrite this technical paper as a front-page news story for a senior software engineer.",
        },
      ],
    ...
    },
    {
      ...
      title: "CreativeGhost",
      description:
        "An AI pair-writer that learns your style and ghostwrites social media threads for you.",
      ...
      prompts: [
        {
          ...
          content:
            "Using the style of the user, explain why Vibe Kit development is the future.",
        },
      ],
    ...
    },
    {
      ...
      title: "DebugMate",
      description:
        "A Chrome extension that watches you code and suggests fixes before you even hit 'Save'.",
      ...
      prompts: [
        {
          label: "Real-time Fix",
          content:
            "The user just typed this: {CODE}. Is there a syntax error or logic flaw?",
        },
      ],
  ...
  episodes: [
    {
      ...
      description:
        "Exploring why the 'vibe' is becoming the primary metric for developer experience in 2025.",
      date: "2025-01-15",
      duration: "45:32",
      thumbnail: "https://picsum.photos/seed/pod1/400/400",
      audioUrl: "#",
      showNotes:
        "In this episode, we talk about the shift from logic-first to feel-first development and how AI is enabling a new class of builders.",
      transcript: [
        {
          speaker: "Host",
          text: "Welcome to VibeKit. Today we're talking about the death of the boilerplate.",
          time: "00:00",
        },
        {
          speaker: "Guest",
          text: "Exactly. If you're writing repetitive code in 2025, you're doing it wrong.",
          time: "00:15",
        },
      ],
    },
    {
      ...
      audioUrl: "#",
      showNotes:
        "A deep dive into the current state of prompt-to-app tooling like v0, bolt, and cursor.",
      transcript: [
        {
          speaker: "Host",
          text: "Is the keyboard the new punch card?",
          time: "00:00",
        },
      ],
    },
    {
      ...
      description: "The ethics of AI co-creation.",
      date: "2025-12-28",
      duration: "52:10",
      thumbnail: "https://picsum.photos/seed/pod3/400/400",
      audioUrl: "#",
      showNotes: "Ethics notes here...",
      transcript: [],
    },
    {
      id: "ep4",
      title: "Scaling Small Teams",
      description: "How one-person startups are out-competing giants.",
      date: "2025-12-15",
      duration: "41:45",
      thumbnail: "https://picsum.photos/seed/pod4/400/400",
      audioUrl: "#",
      showNotes: "Scaling notes...",
      transcript: [],
    },
    {
      id: "ep5",
      title: "The Hardware Gap",
      description: "Will we ever run Pro-level models on our phones?",
      date: "2025-12-01",
      duration: "33:20",
      thumbnail: "https://picsum.photos/seed/pod5/400/400",
      audioUrl: "#",
      showNotes: "Hardware notes...",
      transcript: [],
    },
    {
      id: "ep6",
      title: "Building in Public",
      description: "Why showing your work is the ultimate moat.",
      date: "2025-11-20",
      duration: "48:00",
      thumbnail: "https://picsum.photos/seed/pod6/400/400",
      audioUrl: "#",
      showNotes: "BIP notes...",
      transcript: [],
    },
  ...
  posts: [
    {
      ...
      category: "News",
      excerpt:
        "Deep dive into the new reasoning capabilities that make complex coding tasks a breeze.",
      content:
        "Full content about Gemini 3 Pro reasoning capabilities and how it integrates with developer workflows...",
      date: "2025-01-20",
    ...
    },
    {
      ...
      category: "Tutorial",
      excerpt:
        "Stop wasting time on CSS layout issues. Use these battle-tested prompts instead.",
    ...
    {
      id: "post3",
      title: "Why I'm Moving to Bolt.new for Rapid Prototyping",
      category: "Opinion",
      excerpt: "The shift from local dev to cloud-native prompt environments.",
    ...
    },
    {
      ...
      category: "Analysis",
      excerpt: "What works, what doesn't, and what's coming next.",
      content: "Full analysis content...",
      date: "2025-01-12",
      image: "https://picsum.photos/seed/post4/1200/600",
      author: "Alex Rivers",
    },
    {
      id: "post5",
      ...
      category: "Deep Dive",
      excerpt: "When should you actually bother fine-tuning a model?",
      content: "Full comparison...",
      date: "2025-01-05",
      image: "https://picsum.photos/seed/post5/1200/600",
      author: "Alex Rivers",
    },
    {
      id: "post6",
      title: "AI-Native Design Patterns",
      category: "Design",
      excerpt:
        "UX is fundamentally changing. Here's how to design for the future.",
      content: "Full design article...",
      date: "2025-12-28",
      image: "https://picsum.photos/seed/post6/1200/600",
      author: "Alex Rivers",
    },
    {
      id: "post7",
      title: "Vector Databases Explained for Skeptics",
      category: "Tech",
      excerpt: "Do you really need Pinecone, or is PGVector enough?",
      content: "Full technical guide...",
      date: "2025-12-20",
      image: "https://picsum.photos/seed/post7/1200/600",
      author: "Alex Rivers",
    },
    {
      id: "post8",
      ...
      category: "News",
      excerpt: "Mistral, Llama, and the democratized AI landscape.",
      content: "Full news coverage...",
      date: "2025-12-15",
      image: "https://picsum.photos/seed/post8/1200/600",
      author: "Alex Rivers",
    },
    {
      id: "post9",
      title: "Building an AI SaaS in a Weekend",
      category: "Guide",
      excerpt: "A step-by-step roadmap from idea to first paying customer.",
      content: "Full guide content...",
      date: "2025-12-10",
      image: "https://picsum.photos/seed/post9/1200/600",
      author: "Alex Rivers",
    },
    {
      id: "post10",
      title: "Visual Storytelling with Imagen 4",
      category: "Creative",
      excerpt: "Pushing the boundaries of what's possible in generative art.",
      content: "Full creative post...",
      date: "2025-12-05",
      image: "https://picsum.photos/seed/post10/1200/600",
      author: "Alex Rivers",
    },
  ],
};
