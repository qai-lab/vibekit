...
export const APPS: AppProject[] = [
  {
    ...
    story:
      "A sustainability tracker that uses multi-modal AI to analyze grocery receipts and suggest low-carbon footprint alternatives.",
    prompts: [
  ...
  },
  {
    ...
    story:
      "An enterprise-grade supply chain visualization tool that identifies bottlenecks in real-time using advanced graph algorithms.",
    prompts: [
  ...
  },
  {
    ...
    story:
      "A collaborative music production environment where artists can generate MIDI sequences based on emotional descriptions.",
    prompts: [
...
export const NEWS: NewsItem[] = [
  {
    ...
    date: "2025-11-01",
    summary:
      "Developer creates a new standard for interactive portfolios using Gemini-integrated chat interfaces.",
    url: "#",
  },
  {
    id: "news-2",
    ...
    date: "2025-10-15",
    summary:
      "How frontend engineers are leveraging local LLM models to provide offline-first intelligent UX.",
    url: "#",
  },
  {
    id: "news-3",
    ...
    date: "2025-09-28",
    summary:
      "A deep dive into the latest features of TypeScript and how they improve dev productivity.",
    url: "#",
  },
];
