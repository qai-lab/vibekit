...
export const SITE_DATA: SiteData = {
  apps: [
    {
      ...
      shortDescription:
        "A todo app that manages probabilistic tasks across multiple timelines.",
      description:
        "The Quantum Task Manager is a prototype application built to demonstrate the capabilities of high-frequency state updates in React. It uses a custom hook system to simulate tasks that might or might not exist depending on user observation.",
      featured: true,
    ...
    },
    {
      ...
      shortDescription:
        "Cyberpunk inspired weather visualizations with real-time particle effects.",
      description:
        "Neo Weather reimagines how we consume meteorological data. Instead of boring charts, it uses WebGL to render atmospheric conditions as immersive background environments.",
      featured: false,
      ...
      links: [{ label: "Open Source Code", url: "#" }],
      date: "2025-11-02",
    },
  ],
  podcasts: [
    {
      ...
      showNotes:
        "In this inaugural episode, we discuss why AI is not replacing programmers, but rather evolving the nature of what it means to write instructions for machines.",
      transcript:
        "Welcome to the Vibe Coding podcast... [00:00:15] Today we are joined by Sarah Chen... [00:05:00] Coding is becoming more like creative direction...",
  ...
  insights: [
    ...
    },
    {
      ...
      content:
        "Gemini 2.5 Flash offers unprecedented speed and multimodal capabilities. In this post, we explore how to leverage its native audio processing for real-time applications...",
